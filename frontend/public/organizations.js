...
const getOrganizationsByCategory = (category) => {
...
const getOrganizationWalletAddress = (orgId) => {
...
window.getOrganizationById = getOrganizationById;
window.getCategoryInfo = getCategoryInfo;
window.getOrganizationWalletAddress = getOrganizationWalletAddress;
